...
| M1·M2 에서 찍은 화면 사진 (기도 화면 두 장과 **홈 한 장**은 **얼린 계보**) | `docs/plan/m1-screens/`(기도 · 하루 완주) · `docs/plan/m2-screens/`(홈 · 새 기도 · 여정 상세 · 여정 완주 · 설정 · 초대 코드 · 시트 · 밤 벌) — v5 시안과 나란히 놓고 대조한다. **`home.png` 은 2026-09-18 에 얼렸다** — W2 가 홈을 새 어법으로 다시 세워 그 자리를 계속 찍으면 M2 의 기록이 덮이기 때문이다. 새 홈의 사진은 `docs/plan/w2-screens/` 에 있다 |
