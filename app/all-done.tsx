 ...
 *
 * ── 시안(하루 완주)과 다르게 한 자리 넷 ──────────────────────────────────────
 *
 * 1. **큰 제목이 `쉰네 날을 다 바쳤습니다` 다.** 하루 완주의 제목(`오늘의 묵주기도를
 ...
 *    `이 지향으로 다시 시작하기` 를 둔다 — 여정이 끝난 사람이 가장 자주 하는 다음 일이다.
      ...
      >
        ...
        */}
        ...
        <View style={styles.buttons}>
          ...
          >
            <Text style={styles.primaryLabel}>이 지향으로 다시 시작하기</Text>
          </Pressable>
          <Pressable
          ...
          >
            <Text style={styles.quietLabel}>{strings.toHome}</Text>
          </Pressable>
        </View>
      </View>
    </View>
